//
//  SwiftFontAwesome.swift
//  PROJECT
//
//  Created by Abhishek Ravi on 29/06/17.
...
private let fontAwesome = "FontAwesome"

enum FontAwesomeIcon:UniChar{
    
    case fiveHundredPixels = 0xf26e
    ...
    case googlePlusOfficial = 0xf2b3
    ...
    case windowClose = 0xf2d3
    
    case windowCloseO = 0xf2d4
...
enum fontSize:CGFloat{
    ...
    case tripleExtraLarge = 32.0
    case doubelExtraLarge = 24.0
    case extraLarge = 20.0
    case large = 18.0
    case medium = 16.0
    case small = 14.0
    case extraSmall = 12.0
    case customSize = 10.0 // Change As Per Your Need
}

class SwiftFontAwesome:UILabel{
    
    func icon(type:FontAwesomeIcon){
        
        let myChar:UniChar = type.rawValue
        self.font = UIFont(name: fontAwesome, size: fontSize.medium.rawValue)
        self.text = String(format: "%C", myChar)
    }
    
    func icon(type:FontAwesomeIcon, withSize size:fontSize){
        
        let myChar:UniChar = type.rawValue
        self.font = UIFont(name: fontAwesome, size: size.rawValue)
        self.text = String(format: "%C", myChar)
    }
    
    func icon(type:FontAwesomeIcon, withSize size:fontSize, withColor color:UIColor = UIColor.black, shadowColor shadow:UIColor = UIColor.clear, withAlignment alignment:NSTextAlignment = NSTextAlignment.center){
    ...
    func icon(type:FontAwesomeIcon, withSize size:fontSize, withColor color:UIColor){
    ...
    func icon(type:FontAwesomeIcon, withSize size:fontSize, withColor color:UIColor, shadowColor shadow:UIColor){
